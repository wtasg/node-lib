...
describe("objectToArray", () => {
    ...
    it("filters by key prefix", () => {
        deepStrictEqual(objectToArray({ col_name: "Alice", col_age: 30, id: 1 }, "col_"), ["Alice", 30]);
    });
    it("returns empty array for null", () => {
        deepStrictEqual(objectToArray(null), []);
    });
    it("returns empty array for non-object", () => {
        deepStrictEqual(objectToArray(42), []);
    });
...
//# sourceMappingURL=otoa.test.js.map